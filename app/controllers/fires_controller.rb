class FiresController < ApplicationController
  # expected to find text "As your professional dreams unfold, Aries" in "There's a problem with your routes.rb file.\nunrecognized `fire' .\n/workspace/fortune-teller/config/routes.rb:18"
  def ram
